...
if (argv.length > 2) {
  argv.slice(2).forEach(generateGraph);
};

function generateGraph (jsonPath) {
  ...
  var printHead = function () {
    return 'digraph d {\n' +
      'rankdir=LR\n' +
        ...
        'concentrate=true\n' +
        'splines=true\n' +
        'node [fontname="Helvetica,Sans", fontsize=9, penwidth=1, margin="0, 0.04", height="0.2" ]\n' +
